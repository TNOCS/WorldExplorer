...
public class TerrainHeightGenerator : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        //elevationTexture = Resources.Load("Heightmaps/sampleheightmap") as Texture2D;
        elevationTexture = Resources.Load("Heightmaps/" + AppState.Instance.Config.ActiveView.Zoom + "/" + tileTmsX + "-" + tileTmsY) as Texture2D;
