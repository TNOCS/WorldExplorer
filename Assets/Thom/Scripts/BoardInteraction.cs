...
public class BoardInteraction : Singleton<BoardInteraction>{
    ...
    public float minimumScale = 0.4f; // TODO: find correct values
    ...
    public bool tableIsResizing = false;
    public bool tableIsTilting = false;    
    ...
    {
        //terrain.transform.position = originalTablePosition;
    ...
    public void StartManipulatingTable(GameObject go, string manipulationMode)
    {
        ...
        if (manipulationMode == "TiltInteractable")
        {
            tableIsTilting = true;
        }
        if (manipulationMode == "ResizeInteractable")
        {
